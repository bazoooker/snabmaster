	...
	else
	{
		...
		else
		{
			...
			<div class="bx_ordercart_order_pay_center">
				<a href="javascript:void();" onClick="submitForm('Y'); return false;" class="checkout btn btn_primary-color bg-blue-gradient btn_size-big"><?=GetMessage("SOA_TEMPL_BUTTON")?></a>
			</div>
