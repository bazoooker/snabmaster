...
if($ar_res = $res->GetNext())
  // print_r();
echo "<img width='auto' height='150' src='".CFile::GetPath($ar_res['PREVIEW_PICTURE'])."'/>";?>
...
if (!empty($arResult["SHOW_OFFER_PROPERTIES"]))
{
	...
	<tr>
		...
		?>
		<td>
			<a class="button-delete" onclick="CatalogCompareObj.MakeAjaxAction('<?=CUtil::JSEscape($arElement['~DELETE_URL'])?>');" href="javascript:void(0)"><?=GetMessage("CATALOG_REMOVE_PRODUCT")?></a>
		</td>
		<?
		}
		unset($arElement);
