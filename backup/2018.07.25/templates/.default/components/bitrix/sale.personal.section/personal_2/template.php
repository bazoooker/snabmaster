		...
		<div class="row">
			<div class="col-md-12 sale-personal-section-index">
				<div class="row sale-personal-section-row-flex">
					...
					{
						?>
						<div class="column column-left column-25">
							<div class="sale-personal-section-index-block bx-theme-<?=$theme?>">
								<a class="sale-personal-section-index-block-link link-user link-user_secondary-color" href="<?=htmlspecialcharsbx($blockElement['path'])?>">
