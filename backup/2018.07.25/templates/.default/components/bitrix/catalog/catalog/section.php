...
<?$APPLICATION->IncludeComponent("bitrix:breadcrumb", ".default", Array(
	...
	false
                        ...
                        <div class="sort">
                            ...
                            <a href="/include/setSort.php?dir=name" class="<?=($_COOKIE['sort']=='name'||$_COOKIE['sort']=='')?"active":""?>">по алфавиту</a>
                            <a href="/include/setSort.php?dir=price"  class="<?=($_COOKIE['sort']=='price')?"active":""?>">по цене</a>
                        </div>
		...
		<?$APPLICATION->IncludeComponent(
			...
			array('HIDE_ICONS' => 'Y')
                        ...
                        <!-- a href="#" class="ad section-margin" style="background-image: url(/img/bg/bg-hero.jpg);">
                            <div class="ad__cta">
                                <span class="ad__duration">С 1 арпеля по 30 июля 2018</span>
                                <p class="ad__offer1">Спецпредложение</p>
